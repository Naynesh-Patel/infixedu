    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ProfileRowList(
            "Height".tr,
            _studentDetails.studentData?.user?.height ?? '',
          ),
          ProfileRowList(
            "Weight".tr,
            _studentDetails.studentData?.user?.weight ?? '',
          ),
          ProfileRowList(
            "National ID Number".tr,
            _studentDetails.studentData?.user?.nationalIdNo ?? '',
          ),
          ProfileRowList(
            "Local ID Number".tr,
            _studentDetails.studentData?.user?.localIdNo ?? '',
          ),
          ProfileRowList(
            "Bank Name".tr,
            _studentDetails.studentData?.user?.bankName ?? '',
          ),
          ProfileRowList(
            "Bank Account Number".tr,
            _studentDetails.studentData?.user?.bankAccountNo ?? '',
          ),
        ],
      ),
    );
