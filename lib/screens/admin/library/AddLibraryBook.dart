...
class _AddAdminBookState extends State<AddAdminBook> {
                              ...
                              setState(() {
                                setState(() {
                                  ...
                                  _selectedaAssignDate =
                                      '${_dateTime?.year ?? 0}-${getAbsoluteDate(_dateTime?.month ?? 0)}-${getAbsoluteDate(_dateTime?.day ?? 0)}';
      ...
      child: DropdownButton(
        ...
        onChanged: (value) {
          setState(() {
            ...
            selectedSubjectId = getCode(subjects, value.toString());
          });
        },
  ...
  int? getCode<T>(List<AdminSubject> t, String title) {
    int? code;
    for (var cls in t) {
      if (cls.title == title) {
        code = cls.id;
