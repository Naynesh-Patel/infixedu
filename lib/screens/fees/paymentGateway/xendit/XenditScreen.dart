...
import 'package:Saksham/screens/fees/paymentGateway/xendit/XenditPaymentScreen.dart';
...
import 'package:Saksham/utils/model/XenditErrorResponse.dart';
...
class XenditScreen extends StatefulWidget {
  ...
  const XenditScreen(
      ...
      this.method,
      this.amount,
      this.userDetails}) : super(key: key);
        ...
        if (body['error_code'] == "AMOUNT_BELOW_MINIMUM_LIMIT") {
          showDialog<void>(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: const Text("Amount below minimum limit"),
                actions: <Widget>[
                  TextButton(
              ...
              return AlertDialog(
                ...
                content: SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: xenditErrorResponse.errors?.length ?? 0,
