...
import 'package:Saksham/screens/chat/controller/chat_files_controller.dart';
            ...
            itemBuilder: (context, index) {
              ...
              if (chatMessage.messageType == 1) {
                      ...
                      InkWell(
                        onTap: () {
                          Get.to(() => ImagePreviewPage(
                                title: chatMessage.originalFileName.toString(),
                                imageUrl:
                ...
                return ListTile(
                  ...
                  dense: true,
                  title: Text(
                    chatMessage.originalFileName.toString(),
