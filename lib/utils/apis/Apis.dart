...
class InfixApi {
  ...
  static String getStudentByRoll(
    ...
    return baseApi +
        "search-student?roll_no=$roll&section=$mSection&class=$mClass";
  }
  ...
  static String getStudentBySubject(
    ...
    return baseApi +
        "search-student?section=$mSection&class=$mClass&subject=$subject";
  }
  ...
  static String getSubjectById(dynamic classId, dynamic sectionId) {
    return baseApi +
        "class-section-subjectList?class=$classId&section=$sectionId";
  }
  ...
  static String getSubjectAttendence(
    ...
    return baseApi +
        "student-my-subject-attendance/$id/$recordId?month=$month&year=$year&subject=$subject";
  }
  ...
  static String subjectattendanceCheck(
    ...
    return baseApi +
        "student-subject-attendance-check?date=$date&class=$mClass&section=$mSection&subject=$mSubject";
  }
